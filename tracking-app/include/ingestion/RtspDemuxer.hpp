...
// bilerek native MPP/RGA API'lerine bırakılmıştır (bkz. 06-system-architecture.md,
// Rapor 1 "Hibrit Mimari" kararı). appsink'ten çıkan veri, çözülmemiş
// H.264 Annex-B akışıdır.
class RtspDemuxer {
public:
