...
class BboxGui:
    ...
    def _on_mouse(self, event: int, x: int, y: int, _flags: int, _param) -> None:
        ...
        if event == cv2.EVENT_LBUTTONDOWN:
            ...
            # Gonderildikten sonra onizleme kutusu ekranda KALICI KALMASIN --
            # bir sonraki tracker sonucu (r.track.bbox ciziyor board tarafinda,
            # burada degil) gorununceye kadar bos ekranda dursun, boylece eski
            # secim yeni bir tracking sonucuymus gibi kafa karistirmasin.
